...
for ($i = 0; $i < $num; $i++) {
    ...
    if ($date1 < $date2 || $datetime1 < $datetime2) {
        ...
        echo "<td style='text-align: center;' class=" . $class . ">$dtDatum</td>";

    } elseif ($date1 = $date2 && $datetime1 > $datetime2) {

        echo "<h2 class='major'>Aktuelle Ladungen</h2>";
        echo "<table border='0' id='curr_charging' style='padding: 2%; border: 2px solid red;'>";
        echo "<tr style='text-align: center;'>";
        echo "<td style='text-align: center;' class=" . $class . ">$name</td>";
        echo "<td style='text-align: center;' class=" . $class . ">$f_name</td>";
        echo "<td style='text-align: center;' class=" . $class . ">$email</td>";
